...
const Privacy = () => {
  return (
    <>
     <Head>
        <title>Privacy & Policy | URGE OF IMMIGRATION</title>
        <meta name="description" content="Learn about our privacy policy at URGE OF IMMIGRATION VISA SERVICES. We ensure data privacy and secure handling of your personal information." />
...
<div className='py-3'>
              <MaskText
              text="Any details, information, intellectual or otherwise (documents) provided by the client to URGE OF IMMIGRATION VISA SERVICES will be kept confidential. Information and documents provided by the client will not be shared by any other party EXCEPT for any third party which is a required of the immigration process, such as government bodies or Immigration department and case officers."
              className="text-pri-clr font-pp-neue text-base sm:text-lg md:text-2xl lg:text-3xl"
            />
        </div>
<div className='py-3'>
              <MaskText
              text="With regards to a purchase of a service from this site, we confirm that your credit card/debit card details are not handled by URGE OF IMMIGRATION VISA SERVICES. Your credit card/debit card details will be securely handled by our Payment Services Provider."
              className="text-pri-clr font-pp-neue text-base sm:text-lg md:text-2xl lg:text-3xl"
            />
        </div>
<div className='py-3'>
